  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="border p-4"><p className="text-xs uppercase text-zinc-500">Total Sales</p><p className="mt-2 text-2xl">{formatPriceWithDollarEquivalent(totalSales)}</p></div>
